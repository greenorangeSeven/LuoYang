...
@interface RuhuWeixiuView ()

@end

@implementation RuhuWeixiuView
...
- (void)publishAction
{
    ...
    NSString *updateUrl = [NSString stringWithFormat:@"%@%@", api_base_url, api_addweixiu];
    ...
    switch (errorCode) {
        case 1:
        {
            UIAlertView *av = [[UIAlertView alloc] initWithTitle:@"提示"
                                                         message:@"已收到您提交的报修信息，我们将尽快安排人员与您联系。"
                                                        delegate:nil
                                               cancelButtonTitle:@"确定"
                                               otherButtonTitles:nil];
            [av show];
